...
function displayHex (x,y)
{
 ...
 ////MAJ de la MAP pour fixer la position
	...
	function ClasseCombat(val,personnage)
	{
		return '<table> <caption>'+ personnage + '</caption><tr> <th> Classe armure + arme </th> <td>' + val + '</td> </tr> </table>'
	}
////////////////////////////////////////ONGLETS\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\
